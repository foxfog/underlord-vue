...
const api = {
	...
	dataEditor: {
		...
		listTree: (relDir) => ipcRenderer.invoke('data-editor-list-tree', relDir),
		createDir: (relDir) => ipcRenderer.invoke('data-editor-create-dir', relDir),
		deleteDir: (relDir) => ipcRenderer.invoke('data-editor-delete-dir', relDir),
