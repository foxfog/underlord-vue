...
import schedulesData from '@data/characters/schedules.json'
import scenesData from '@data/scenes/scenes.json'
import menuStory from '@data/story/ru/carne-chief/menu.json'
import talkStory from '@data/story/ru/carne-chief/talk.json'
