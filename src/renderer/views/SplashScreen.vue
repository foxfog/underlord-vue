<template>
	<div
		class="splash-screen"
		:style="{
			'--transition-duration': config.transitions.duration + 'ms',
			'--transition-easing': config.transitions.easing
		}"
		:class="{ '__transitions-disabled': !config.transitions.enabled }"
	>
		<div class="section section-0" :class="{ __show: currentSection === 0 }">
			<div class="_box ui-poscen">
				...
				<div class="_text-box">
					<p>
						«Underlord» является художественным произведением. Все события, персонажи,
						локации и ситуации вымышлены. Любое сходство с реальными людьми,
						организациями или событиями является случайным.
					</p>
					<p>
						Игра может содержать яркий свет, резкие звуки, сцены насилия, упоминания
						алкоголя или иного контента, неподходящего для некоторых игроков.
						Рекомендуется играть в осознанном состоянии и с перерывами.
					</p>
					<p>
						Разработчик не несёт ответственности за возможный физический,
						психологический или эмоциональный дискомфорт, полученный в процессе игры.
						Устанавливая и/или запуская игру, вы соглашаетесь с этими условиями.
					</p>
					<p>
						Спасибо, что играете в независимые проекты. Ваш интерес помогает нам
						создавать новое.
					</p>
				</div>
			</div>
		...
		<div class="section section-1" :class="{ __show: currentSection === 1 }">
			<div class="_box ui-poscen">
				<div class="_title">
		...
		<div class="section section-2" :class="{ __show: currentSection === 2 }">
			<div class="_box ui-poscen">
				<div class="_title">
		...
		<div class="section section-3" :class="{ __show: currentSection === 3 }">
			<div class="_box ui-poscen">
