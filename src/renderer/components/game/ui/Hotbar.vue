<template>
	<div v-if="visible" class="hotbar">
		<button class="hotbar-btn" @click="$emit('open-history')">История</button>
		<button class="hotbar-btn" @click="$emit('open-menu')">Главное меню</button>
