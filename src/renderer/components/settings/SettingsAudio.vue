	...
	<div class="settings-list">
		<div class="settings-item">
			...
			<div class="right">
				...
				<uiPlayerAudio
					:key="'common-' + audioKeys.music"
					:src="''"
					volumeType="common"
					:resetOnStop="true"
					:randomMode="true"
					:audioFolder="audioFolders.music"
					:stopBgMusic="true"
					class="_btn"
				/>
			</div>
		...
		<div class="settings-item">
			...
			<div class="right">
				...
				<uiPlayerAudio
					:key="'sound-' + audioKeys.sound"
					:src="''"
					volumeType="sound"
					:resetOnStop="true"
					:randomMode="true"
					:audioFolder="audioFolders.sound"
					:stopBgMusic="true"
					class="_btn"
				/>
			</div>
		...
		<div class="settings-item">
			...
			<div class="right">
				...
				<uiPlayerAudio
					:key="'voice-' + audioKeys.voice"
					:src="''"
					volumeType="voice"
					:resetOnStop="true"
					:randomMode="true"
					:audioFolder="audioFolders.voice"
					:stopBgMusic="true"
					class="_btn"
				/>
			</div>
