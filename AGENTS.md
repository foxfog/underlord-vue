...
* [Гексагональная тактическая карта и редактор (`docs/systems/HexMapSystem.md`)](docs/systems/HexMapSystem.md) — тактическая flat-topped 2.5D карта, реки по граням в стиле Civilization (ширина 1–3), государственные границы и территории (Civ style), фильтр границ, горные массивы R1–3, холмы, поселения, дороги с авто-мостами, визуальный редактор.
